...
import com.project.prediction_application.ui.home.MatchListFragment
...
class MatchListAdapter(
    ...
    private val matchListClickListener: MatchListFragment
) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is ItemViewHolder) {
            ...
            holder.itemOffersBinding.tvSecondTeamName.text = "VS"
            holder.itemOffersBinding.tvVs.text = "NZ"
            holder.itemOffersBinding.tvDateTime.text = list?.get(position)
            ...
            val receivedTime = list?.get(position) //"25-03-2021 14:05:00"
